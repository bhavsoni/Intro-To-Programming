...
void generate_moves(char _board[9], list<int> &move_list);
...
static string game_type; // 'human vs human', 'human vs computer', 'computer vs computer'
static string prev_game_type; // variable for storing previous 'game type'
...
void select_game_type() {
    ...
    cout << "   4 - start automatic game" << endl;
    cout << "   5 - display game statistic" << endl;
    cout << "   6 - set display mode" << endl;
    cout << "   7 - quit the program" << endl;
    cout << "\nselection: ";
    int choice;
    cin >> choice;
    if(!cin.good()) {
        cout << "please notice that you can only enter integers for the selection" << endl;
        update_screen();
    }
    switch(choice) {
        case 1:
...
void get_player_symbol() {
    if(game_type == "human vs computer") {
        ...
        cout << player_name << " will play \'" << cSymbol << "\'" << endl;
    }
    if(!cin.good() || wrong_symbol()) {
        cout << "please notice that your symbol can only be X or O" << endl;
        system("pause");
        get_player_symbol();
    }
    if(!player2.selected) {
...
void display_game_statistic() {
    if(state != START) {
        cout << "\ngame statistic" << endl;
        cout << "==============" << endl;
        cout << player1.name << " has won " << player1.game_win << " game(s)." << endl;
        cout << player2.name << " has won " << player2.game_win << " game(s)." << endl;
        cout << player1.draw_num << " game(s) ended with a draw." << endl;
    }
}
...
void select_display_mode() {
    cout << "\n===================" << endl;
    cout << "seting display mode" << endl;
    cout << "===================" << endl;
    cout << "   1 - regular" << endl;
    cout << "   2 - progressive" << endl;
    cout << "\nchoice: ";
    int choice;
    cin >> choice;
    while(choice != 1 && choice != 2) {
        cin.clear();
        cin.sync();
        cout << "wrong selection, choose '1' or '2': ";
        cin >> choice;
    }
    cout << "the display mode was sucessfuly changed!" << endl;
    if(choice == 1) {
...
void display_result() {
    if(player1.win) {
        cout << player1.name << " has won the game!" << endl;
    } else if(player2.win) {
        cout << player2.name << " has won the game!" << endl;
...
void display_game_progress() {
    ...
    cout << "\n\nboard position after " << current_player.name << "\'s move" << endl;
    display_board();
}
...
void display_intro() {
    cout << "\n=========================================" << endl;
    cout << "  TicTacToe game v1.0 - Gonzales Cenelia	" << endl;
    cout << "=========================================" << endl;
}
